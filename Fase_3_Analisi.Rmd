...
```{r find-marker-step1, echo=TRUE, message=FALSE, eval=FALSE, warning=FALSE}
...
```{r save-markers1, echo=TRUE, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r filter_markers, eval=FALSE, echo=TRUE, warning=FALSE, message=FALSE}
markers_res01 <- markers_res01 %>%
...
```{r save_markers_filtrati, echo=TRUE, message=FALSE, warning=FALSE, eval=FALSE}
...
markers_res01 <- readRDS(file.path(results_path, "bone_markers_filtrati.rds"))
```
...
```{r top30, eval=FALSE, echo=TRUE, warning=FALSE, message=FALSE}
